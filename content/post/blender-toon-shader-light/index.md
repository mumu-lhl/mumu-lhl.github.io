...
而且你会发现，物体表面受到的光源影响是 PBR 风格（软边缘，颜色存在渐变）的，目前通过这种方法无法实现 NPR 风格的光源影响（如硬边缘、颜色固定）。
...
截止这篇文章写出的时候，Blender 正在开发 **灯光材质节点（Material Lighting Nodes）**，这是 Blender Project 上的 [issue](https://projects.blender.org/blender/blender/issues/139341) 和 [PR](https://projects.blender.org/blender/blender/pulls/161429)。

这个功能包含了四个节点：*Light Info*， *Light Evaluation*， *Shadow Raycast* 和 *Light Accumulation*

这些节点可以完美的替代这篇文章的方法，并且可以解决光源影响不够 NPR 风格的问题。

这些节点正在开发，还尚且存在着 bug，根据开发进度，推测可能在 Blender 5.3 或者 5.4 发布。期待在正式版中的上线吧。
